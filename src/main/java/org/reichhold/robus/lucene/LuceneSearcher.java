...
public class LuceneSearcher {
    ...
    public List<RoleSearchResult> doRoleSearches(String roleName, List<String> queries, int maxResults) {
        List<RoleSearchResult> results = new ArrayList<RoleSearchResult>();

        for (String query:queries) {
            RoleSearchResult result = doRoleSearch(roleName, query, maxResults);
            results.add(result);
        }
